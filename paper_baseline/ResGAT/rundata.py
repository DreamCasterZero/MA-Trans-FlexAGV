...
parser.add_argument('--method', type=str, default="gnn", help="算法名称")
...
job_model_path = os.path.join(model_dir, 'job_actor_gnn_best_20x10.pt') # 或者是 .pt
agv_model_path = os.path.join(model_dir, 'agv_actor_gnn_best_20x10.pt')
